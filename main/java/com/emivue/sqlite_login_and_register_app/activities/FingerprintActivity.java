...
import fingerprintauth.AuthErrorCodes;
import fingerprintauth.FingerPrintAuthCallback;
import fingerprintauth.FingerPrintAuthHelper;
import fingerprintauth.FingerPrintUtils;
        ...
        pinEt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.toString().equals("1234")){
                    ...
                    startActivity(new Intent(FingerprintActivity.this, AuthSuccessScreen.class));
                }
            }
